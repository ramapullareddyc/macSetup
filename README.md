...
**Security:** [AdGuard](https://adguard.com) (ad/tracker blocker), [AdGuard VPN](https://adguard-vpn.com), [Deeper Network DPN](https://deeper.network) (decentralized VPN — installed via DMG), [Moonlock](https://macpaw.com/moonlock) (MacPaw) — Moonlock installed via DMG (not in Homebrew)
